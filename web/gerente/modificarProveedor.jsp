    ...
    <body>
        ...
        <div id="content">
            ...
            <body><center>
                ...
                <br>
                <br>
                <form method="get" action="${pageContext.request.contextPath}/ModificarProveedor">
                    Proveedor:<select name="id_proveedor" size="1" required>
                ...
                <br>
                <br>
                <form method="post" action="${pageContext.request.contextPath}/ModificarProveedor" name="myForm" onsubmit="return(validate());">
                    ...
                    <br class="clear" />
                    <br />
                    <input type="submit" name="boton" value="Modificar Proveedor" />
